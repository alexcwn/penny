...
func Start(port int, data *models.ArchiveData) error {
	...
	http.HandleFunc("/api/n2osids-logs", handleN2OSIDSLogs)
	http.HandleFunc("/api/n2osidsevents-logs", handleN2OSIDSEventsLogs)
	http.HandleFunc("/api/n2osalert-logs", handleN2OSAlertLogs)
	http.HandleFunc("/api/n2osalertevents-logs", handleN2OSAlertEventsLogs)
	http.HandleFunc("/api/n2osproduction-logs", handleN2OSProductionLogs)
